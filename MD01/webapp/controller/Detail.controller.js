/*global location */
sap.ui.define([
	"MD_Namespace/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"MD_Namespace/model/formatter"
], function (BaseController, JSONModel, formatter) {
	"use strict";
	return BaseController.extend("MD_Namespace.controller.Detail", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
...
_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("Objects", { ObjectID: sObjectId });
...
this.getOwnerComponent().oListSelector.clearMasterListSelection();
			...
			var sPath = oElementBinding.getPath(), oResourceBundle = this.getResourceBundle(), oObject = oView.getModel().getObject(sPath), sObjectId = oObject.ObjectID, sObjectName = oObject.ObjectID, oViewModel = this.getModel("detailView");
...
oViewModel.setProperty("/delay", iOriginalViewBusyDelay);
		...
		/**
	*@memberOf MD_Namespace.controller.Detail
	*/
	GoToPage3: function () {
	//This code was generated by the layout editor.
	// TODO: Navigate to another M-D View...
			},
			/**
		*@memberOf MD_Namespace.controller.Detail
		*/
