sap.ui.define([
		...
		return BaseObject.extend("MD_Namespace.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias MD_Namespace.model.ListSelector
			 */
			 ...
			 * @return {MD_Namespace.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
