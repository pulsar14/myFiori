...
sap.ui.define([
		...
		return BaseController.extend("MD_Namespace.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("MD_Namespace.view.ViewSettingsDialog", this);
