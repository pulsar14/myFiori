sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("MD_Namespace/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("MD_Namespace.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["MD_Namespace/localService/mockserver"], function (mockserver) {
