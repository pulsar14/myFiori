sap.ui.define([
		"MD_Namespace/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("ObjectID").length, 1, "The sorting by ObjectID returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by ObjectID and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "UnitNumber");

		this.oGroupSortState.sort("ObjectID");
