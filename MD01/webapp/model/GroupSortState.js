sap.ui.define([
	...
	return BaseObject.extend("MD_Namespace.model.GroupSortState", {
		 ...
		 * @alias MD_Namespace.model.GroupSortState
		 */
		...
		/**
		 * Sorts by ObjectID, or by UnitNumber
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "UnitNumber") {
				...
				this._oViewModel.setProperty("/sortBy", "ObjectID");
			}
